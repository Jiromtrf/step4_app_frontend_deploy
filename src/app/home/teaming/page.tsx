...
export default function Teaming() {
  ...
  const [currentTeamId, setCurrentTeamId] = useState<number | null>(null); // チームIDステート追加
  const [selectedRole, setSelectedRole] = useState<string | null>(null); // 選択中のロール保存
