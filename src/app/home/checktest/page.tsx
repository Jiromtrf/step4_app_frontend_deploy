// frontend/src/app/home/checktest/page.tsx
"use client";
...
import HomeButton from "../../components/HomeButton"; // HomeButton をインポート（パスを確認）
...
export default function QuizHome() {
    ...
    if (session) {
      fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/get_all_dates`)
        ...
        .catch((err: any) => {
          ...
          setError(err.message || "日付一覧の取得に失敗しました");
          setIsLoading(false);
        });
    }
  }, [session]);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-orange-100 text-black relative">
      {/* ホームボタンを左上に固定 */}
